"""Real-server Telegram proxy connectivity smoke test.

Run this manually on the deployment host/container with TG_PROXY_ENABLED=true
and an authorized Telegram session. It performs a real Telegram get_me call.
"""

...
def init_database():
    with get_connection() as conn:
        with conn.cursor() as cursor:
            ...
            if 2 not in applied:
                cursor.execute("""
                    CREATE TABLE IF NOT EXISTS users (id BIGSERIAL PRIMARY KEY, username TEXT UNIQUE NOT NULL, password_hash TEXT NOT NULL, role TEXT NOT NULL DEFAULT 'user', enabled BOOLEAN NOT NULL DEFAULT TRUE, created_at BIGINT NOT NULL DEFAULT EXTRACT(EPOCH FROM NOW())::BIGINT);
